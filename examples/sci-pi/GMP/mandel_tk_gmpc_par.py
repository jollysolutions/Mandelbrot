...
# Mandelbrot set using tkinter, GMP, multiprocessing and a C extension,
# along with matplotlib for colour maps
# MJR 7/2022  http://www.sci-pi.org.uk/maths/mandel_fixed3.html
...
def mandel_column(x_in,ymin,ymax,size,maxiter):
    ...
    for j in range(0,size):
        ...
        col[j]=1-gmp_mandel.mandel(x0,y0,bshift,maxiter)/maxiter
